...
// Threat Modeling configuration navigation (per 07_admin_console.md)
const threatModelingNavigation: NavItem[] = [
  {
    name: 'Shape Mappings',
    href: '/shape-mappings',
    icon: (
  ...
  {
    name: 'Canonical Risks',
    href: '/canonical-risks',
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const navigationSections: NavSection[] = [
  ...
  { title: 'Threat Modeling Config', items: threatModelingNavigation },
