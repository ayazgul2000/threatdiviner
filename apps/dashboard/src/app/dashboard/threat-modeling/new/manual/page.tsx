...
export default function ManualThreatModelPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!currentProject) {
      setErrors({ submit: 'Please select a project first' });
      return;
    }
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Manual Entry</h1>
          <p className="text-gray-500 dark:text-gray-400 mt-1">
            Start from scratch with a blank diagram
          </p>
        </div>
      </div>
