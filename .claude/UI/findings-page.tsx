...
export default function FindingsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title={scanInfo ? `Findings: ${scanInfo.repoName}` : 'Findings'}
        description={
          scanInfo 
      ...
      {scanIdParam && (
        <div className="flex items-center gap-2 text-sm text-gray-600 bg-gray-50 dark:bg-gray-800 px-4 py-2 rounded-lg">
          <span>Scan:</span>
          <code className="bg-gray-200 dark:bg-gray-700 px-2 py-0.5 rounded font-mono">{scanIdParam.substring(0, 8)}...</code>
...
=== C:\Dev\threatdiviner-v0.2.0\apps\dashboard\src\app\dashboard\findings\[id]\page.tsx ===
=== C:\Dev\threatdiviner-v0.2.0\apps\dashboard\src\app\dashboard\pen-testing\page.tsx ===
'use client';
